...
public class AlienMaster : MonoBehaviour
{
    ...
    private const float MAX_LEFT = -3.25f;
    private const float MAX_RIGHT = 3.25f;
    ...
    private const float MIN_MOVE_SPEED = 0.02f;
    public GameObject motherShipPrefab;
    private Vector3 motherShipSpawnPos = new Vector3(3.1f, 5.25f, 0);
    private float motherShipTimer = 10f;
    private const float MOTHERSHIP_SPAWN_MIN = 15f;
    private const float MOTHERSHIP_SPAWN_MAX = 60f;
    ...
    private void SpawnMotherShip()
    {
        ...
        motherShipTimer = Random.Range(MOTHERSHIP_SPAWN_MIN, MOTHERSHIP_SPAWN_MAX);
    }
